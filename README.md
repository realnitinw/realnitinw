...
* **Neural Networks:** Implementing multi-layer perceptrons, understanding **Backpropagation**, and **Gradient Descent**.
* **Model Optimization:** Expertise in **Regularization (L1/L2)** and Hyperparameter tuning.
* **Evaluation Metrics:** Precision, Recall, and $F_1$ Scores for imbalanced datasets.
